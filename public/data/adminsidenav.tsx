export const sidenavData = [
  ...
  },
  {
    id: 4,
    name: "Hospital",
    icon: <i className="las la-heartbeat text-2xl"></i>,
    submenus: [
      { url: "hospital-info", title: "Add New Hospital" },
  ...
  },
  {
    id: 5,
    name: "SoS",
    icon: <i className="las la-ambulance text-2xl"></i>,
    submenus: [
      { url: "sos-list", title: "SoS" },
