      ...
      <div className="py-4">
        <div className="container-fluid">
          <div className="grid grid-cols-12 gap-4 lg:gap-6 px-3 lg:px-4">
            <div className="col-span-12 lg:col-span-4">
              <div className="grid grid-cols-12 gap-4 lg:gap-6">
                <div className="col-span-12 md:col-span-6">
                  <Link
                    href="/img/Marasca Khao Yai, Khao Yai 1.jpeg"
                    className="link property-gallery">
                    <Image
                      width={294}
                      height={287}
                      src="/img/Marasca Khao Yai, Khao Yai 1.jpeg"
                      alt="image"
                ...
                <div className="col-span-12 md:col-span-6">
                  <Link
                    href="/img/Marasca Khao Yai, Khao Yai 2.jpeg"
                    className="link property-gallery">
                    <Image
                      width={294}
                      height={287}
                      src="/img/Marasca Khao Yai, Khao Yai 2.jpeg"
                      alt="image"
                      className=" g-img w-full"
                    />
                  </Link>
                ...
                <div className="col-span-12">
                  <Link
                    href="/img/Marasca Khao Yai, Khao Yai 3.jpeg"
                    className="link property-gallery">
                    <Image
                      width={610}
                      height={593}
                      src="/img/Marasca Khao Yai, Khao Yai 3.jpeg"
                      alt="image"
                      className=" g-img w-full"
                    />
                  </Link>
            ...
            <div className="col-span-12 lg:col-span-4">
              <Link
                href="/img/Marasca Khao Yai, Khao Yai 4.jpeg"
                className="link property-gallery">
                <Image
                  width={610}
                  height={288}
                  src="/img/Marasca Khao Yai, Khao Yai 4.jpeg"
                  alt="image"
                  className=" g-img w-full"
                />
              </Link>
            ...
            <div className="col-span-12 lg:col-span-4">
              <div className="grid grid-cols-12 gap-4 lg:gap-6">
                <div className="col-span-12">
                  <Link
                    href="/img/Marasca Khao Yai, Khao Yai 5.jpeg.jpg"
                    className="link property-gallery">
                    <Image
                      width={610}
                      height={288}
                      src="/img/Marasca Khao Yai, Khao Yai 5.jpeg"
                      alt="image"
                      className=" g-img w-full"
                    />
                  </Link>
                ...
                <div className="col-span-12 md:col-span-6">
                  <Link
                    href="/img/Marasca Khao Yai, Khao Yai 6.jpeg.jpg"
                    className="link property-gallery">
                    <Image
                      width={294}
                      height={287}
                      src="/img/Marasca Khao Yai, Khao Yai 6.jpeg"
                      alt="image"
                      className=" g-img w-full"
                    />
                  </Link>
            ...
            <div className="mb-6 md:mb-10 lg:mb-14">
              <div className="bg-white rounded-2xl p-3 sm:p-4 lg:py-8 lg:px-5">
                <div className="p-3 sm:p-4 lg:p-6 bg-[var(--bg-1)] rounded-2xl border mb-10">
                  ...
                  Marasca Khao Yai, Khao Yai
                  </h2>
                  <ul className="flex flex-wrap items-center gap-4 gap-md-0">
                    <li>
                      <div className="flex items-center gap-2">
                        <MapIcon className="w-5 h-5 text-[var(--secondary)]" />
                        <p className="mb-0"> หมู่ที่ 5, 87, Tambon Phaya Yen, Amphoe Pak Chong, Chang Wat Nakhon Ratchasima </p>
                      </div>
                    </li>
                    <li>
                      <p className="mb-0">
                ...
                <div className="p-3 sm:p-4 md:p-6 bg-[var(--bg-1)] rounded-2xl border border-neutral-40 mb-6 md:mb-10">
                  ...
                  หากร่างกายต้องการธรรมชาติ เขาใหญ่คือคำตอบ เพราะขับรถจากกรุงเทพฯ เพียงแค่ 3 ชั่วโมง ก็จะได้พบกับที่พักแบบ 
                  Glamping Luxury ท่ามกลางธรรมชาติ ให้ความรู้สึกหรูหราแต่อบอุ่น ด้วยบรรยากาศเหมือนไปกางเต็นท์ แต่ยังคงมีความสะดวกสบายครบครัน 
                  มีห้องพักให้เลือกมากถึง 6 รูปแบบ ไม่ว่าจะเป็นแบบเต็นท์ แบบห้องพัก วิลล่าหลังใหญ่ หรือพูลวิลล่า (Pool Villa) เหมาะกับการเข้าพักเป็นครอบครัวและกลุ่มเพื่อน 
                  สาระสำคัญที่สุดคือ Marasca เป็นที่พักแบบ Pet Friendly ในเขาใหญ่ที่สุนัขเข้าได้ ซึ่งน้องหมาจะสามารถเข้าพักได้ในห้องประเภท Home Haven Villa 
                  เข้าใช้บริการร้านอาหาร Tree Top Cafe ชั้น 1 รวมถึงในสวน Homegrown และ The Meadow ได้อีกด้วย เท่านั้นยังไม่พอ สายกิจกรรมจะต้องถูกใจ
                   เพราะที่นี่เค้ามีการจัดกิจกรรม workshop ต่างๆ อยู่เรื่อยๆ ด้วย
                  </p>
                  <Link
                    href="#"
                ...
                <div className="p-3 sm:p-4 md:p-6 bg-[var(--bg-1)] rounded-2xl border border-neutral-40 mb-6 md:mb-10">
                  ...
                  <div className="bg-white p-1 rounded-2xl overflow-hidden relative h-[462px] z-[1]">
                    <ReactPlayer
                      url="https://www.youtube.com/watch?v=REIn2FW7ZEk"
                      controls
                ...
                <div className="p-3 sm:p-4 md:p-6 bg-[var(--bg-1)] rounded-2xl border border-neutral-40 mb-6 md:mb-10">
                  ...
                  <div className="w-full">
                    <iframe
                      ...
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3861.5700717374216!2d101.24751497510549!3d14.566561085915744!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x311dcf550f661965%3A0xdc7fb3c141f0d5ef!2sMarasca%20Khao%20Yai!5e0!3m2!1sen!2sth!4v1711005603470!5m2!1sen!2sth"></iframe>
                  </div>
                </div>
                <div className="p-3 sm:p-4 md:p-6 bg-[var(--bg-1)] rounded-2xl border border-neutral-40 mb-6 md:mb-10">
              ...
              <div className="bg-white rounded-2xl py-8 px-6">
                ...
                <div className="flex items-start gap-2 mb-6">
                  <div className="flex gap-3 items-center">
                    ...
                    <h3 className="h3 mb-0"> ฿25,976 </h3>
                  </div>
                  ...
                  <Tab.Panels className="mt-5">
                    <Tab.Panel
                      ...
                      <div className="flex items-center justify-between my-4">
                        <p className="mb-0 clr-neutral-500"> ฿25,976x 4 night </p>
